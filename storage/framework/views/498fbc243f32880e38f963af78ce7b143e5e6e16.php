                    ...
                    <form name="frm_contact_us" id="frm_contact_us" method="post" action="<?php echo e($module_url_path); ?>/contact_us/store">
                        ...
                        <div class="prescription-section contact-section">
                            <div class="form-group">
                                ...
                                <input type="text" id="doctor_name" name="doctor_name" placeholder="Doctor Name" maxlength="50" value="<?php echo e(isset($full_name)?$full_name:''); ?>" readonly />
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" name="email" placeholder="Email Id" maxlength="80"  value="<?php echo e(isset($email)?$email:''); ?>" readonly />
                                        ...
                                        <option value="">Code</option>
                                            <?php if(!empty($mobcode_data) && isset($mobcode_data)): ?>
                                                <?php foreach($mobcode_data as $mobcode): ?>
                                                    <option value="<?php echo e($mobcode['phonecode']); ?>" <?php if(isset($phone_code) && $phone_code!='' && $phone_code == $mobcode['phonecode']): ?> selected <?php endif; ?>>+<?php echo e($mobcode['phonecode']); ?> (<?php echo e($mobcode['iso3']); ?>)</option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                ...
                                <input type="hidden" name="hidden_phone_code" value="<?php echo e($phone_code); ?>">

                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label class="form-label">Mobile Number<i class="red">*</i></label>
                                        <input type="text" placeholder="Enter Mobile no." id="mobile_no" name="mobile_no" maxlength="16"  value="<?php echo e(isset($mobile_no)?$mobile_no:''); ?>" readonly />
