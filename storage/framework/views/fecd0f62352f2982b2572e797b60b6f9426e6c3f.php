...
<link href="<?php echo e(url('/')); ?>/public/fullcalendar/css/fullcalendar.css" rel="stylesheet" />
<link href="<?php echo e(url('/')); ?>/public/fullcalendar/css/fullcalendar.print.css" rel='stylesheet' media='print' />

<script src="<?php echo e(url('/')); ?>/public/fullcalendar/lib/moment.js"></script>
<script src="<?php echo e(url('/')); ?>/public/fullcalendar/lib/jquery.js"></script>
<script src="<?php echo e(url('/')); ?>/public/fullcalendar/js/fullcalendar.js"></script>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 col-md-3 col-lg-3">
                ...
                <?php if($is_pause == "1"): ?>
                  <a onclick="confirm_action(this,event,'Do you really want to resume new consultation?')" href="<?php echo e($module_url_path.'/resume'); ?>" class="btn btn-danger pause-new-btn">Pause</a>
                <?php else: ?>
                  <a onclick="confirm_action(this,event,'Pre-booked consultations will not be canceled!     Do you really want to pause new consultation ?')" href="<?php echo e($module_url_path.'/pause'); ?>" class="btn btn-success pause-new-btn">Resume</a>
                <?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="Availability-form">
                        ...
                        <?php /* <button class="green-btn close_btn" data-dismiss="modal" id="btn_cancel" style="display: none;">Cancel</button> */ ?>
...
<!--datepicker start-->
<script type="text/javascript" src="<?php echo e(url('/')); ?>/public/front/js/bootstrap-datepicker.min.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/front/css/bootstrap-datepicker.min.css"/>
<!--datepicker end-->

<!--timepicker start-->
<script type="text/javascript" src="<?php echo e(url('/')); ?>/public/front/js/bootstrap-timepicker.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/public/front/css/timepicker.css"/>
<!--timepicker end-->
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $.ajax({
            url  :"<?php echo e($module_url_path); ?>/available_dates",
            type :'get',
                ...
                if(data)
                {
                    ...
                    calendar = $('#calendar').fullCalendar({
                        ...
                        eventDrop : function( event, delta, revertFunc )
                        {
                            ...
                            $.ajax({
                                url     : "<?php echo e($module_url_path); ?>/update",
                                type    : 'post',
                    ...
                    $("#btn_delete").click(function()
                    {
                        ...
                        $.ajax({
                            url  : "<?php echo e($module_url_path); ?>/delete",
                            type : 'post',
                    ...
                    $("#btn_add").click(function()
                    {
                        ...
                        $.ajax({
                            url        : "<?php echo e($module_url_path); ?>/add",
                            type       : 'post',
