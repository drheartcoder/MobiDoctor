  ...
  .form-horizontal .btn-group { margin-bottom: -43px;}
    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Consultation Transactions <?php echo e(isset($page_title) ? $page_title : ''); ?></li>
        </ul>
    </div>
    <!-- END Breadcrumb -->
  ...
  <div class="box">
            <div class="box-title">
              <h3>
               ...
               Consultation Transactions <?php echo e(isset($page_title) ? $page_title : ""); ?>
                 ...
                 <tbody>
                  	<?php if(isset($arr_transaction) && sizeof($arr_transaction)>0): ?>
                        ...
                        <tr>
                          ...
                          <td><?php echo e(isset($data['consultation_id']) ? $data['consultation_id'] : '-'); ?></td>
