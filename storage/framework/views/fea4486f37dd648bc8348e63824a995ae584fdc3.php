    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form method="post" id="frm_discount_code" name="frm_discount_code" action="<?php echo e(url($module_url_path.'/store')); ?>" class="form-horizontal">
                    ...
                    <div class="col-sm-6 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                             ...
                             <span id="err_price" style="color:red;"><?php echo e($errors->first('price')); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                                ...
                                <span id="err_start_date" style="color:red;"><?php echo e($errors->first('start_date')); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-8 controls">
                                ...
                                <span id="err_end_date" style="color:red;"><?php echo e($errors->first('end_date')); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6 col-lg-8 controls">
                             ...
                             <span id="err_status" style="color:red;"><?php echo e($errors->first('status')); ?></span>
                          </div>
                        </div>
                    </div>
