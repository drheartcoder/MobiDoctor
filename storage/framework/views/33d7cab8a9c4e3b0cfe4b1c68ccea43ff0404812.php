...
<div class="col-md-12">
   <div class="box box-blue">
      ...
      <br/>
      <form method="post" action="<?php echo e(url($module_url_path.'/update')); ?>/<?php echo e(base64_encode($blog_details['id'])); ?>" id="validation-form" class="form-horizontal" enctype="multipart/form-data" name="Form" >
                  ...
                  <div class="box-content">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                           <input type="text" name="title" class="form-control" id="title" placeholder="Title" value="<?php echo e(isset($blog_details['title'])?decrypt_value($blog_details['title']):''); ?>" >
                    ...
                    <div class="form-group">
                              ...
                              <option value=""></option>
                                  <?php if(isset($arr_category) && sizeof($arr_category)>0): ?>
                                      <?php foreach($arr_category as $category): ?>
                                         <option value="<?php echo e($category['id']); ?>" <?php if(in_array($category['id'],$arr_blog_category)): ?> selected <?php endif; ?>><?php echo e(isset($category['name'])?decrypt_value($category['name']):''); ?></option>
                                      <?php endforeach; ?>
                                  <?php endif; ?>
                           </select>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                           <input type="text" name="date" placeholder="Date" id="date" class="form-control datepicker" value="<?php echo e(isset($blog_details['date'])?$blog_details['date']:''); ?>">
                     ...
                     <div class="form-group ">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                           <input type="text" name="posted_by" id="posted_by"  placeholder="Posted By" class="form-control" value="<?php echo e(isset($blog_details['posted_by'])?decrypt_value($blog_details['posted_by']):''); ?>">
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-7 controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <input type="hidden" value="<?php echo e($default_img_path.'/blog.jpg'); ?>" id="default_image">
                                    <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                        <?php if(isset($blog_details['image']) && !empty($blog_details['image']) && $blog_details['image'] != null && file_exists($blog_image_base_img_path.$blog_details['image'])): ?>
                                            <?php $blog_image = $blog_details['image']; ?>                    
                                        <img src="<?php echo e($blog_image_public_img_path.$blog_details['image']); ?>" id="preview" >
                                        <?php else: ?>
                                        <img src="<?php echo e($default_img_path.'/blog.jpg'); ?>" id="preview" >                    
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div>
                                        <span class="btn btn-default btn-file" style="height:32px;">
                                            ...
                                            <input type="hidden" class="file-input " name="oldimage" id="oldimage" value="<?php echo e($blog_details['image']); ?>"/>
                                        </span>
                                    </div>
                                    <i class="red"> 
                                        ...
                                        <span for="image" id="err_image" class="help-block"><?php echo e($errors->first('blog_image')); ?></span>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                        </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                           <input type="text" name="meta_title" class="form-control" id="meta_title" placeholder="Meta Title"value="<?php echo e(isset($blog_details['meta_title'])?decrypt_value($blog_details['meta_title']):''); ?>">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                           <input type="text" name="meta_keyword" class="form-control" id="meta_keyword" placeholder="Meta Keyword"value="<?php echo e(isset($blog_details['meta_keyword'])?decrypt_value($blog_details['meta_keyword']):''); ?>">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-7 controls">
                           <input type="text" name="meta_desc" class="form-control" id="meta_desc" placeholder="Meta description" value="<?php echo e(isset($blog_details['meta_desc'])?decrypt_value($blog_details['meta_desc']):''); ?>">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="form-group">
                           <div class="col-sm-8 col-lg-8 controls">
                              <textarea class='form-control desc' id='template_html' name="description" rows='10' data-rule-required='true' placeholder='Email Template Body'><?php echo e(isset($blog_details['description'])?decrypt_value($blog_details['description']):''); ?></textarea>
