                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6 list_view" style="display: none;">
                                    <div class="doctoe-consultation-section dot-menu-set">
                                        <div class="consultation-img">
                                            <img src="<?php echo e($doc_img_src); ?>" class="img-responsive" alt="MobiDoctor"/>
                                        </div>
                                        
                                        <div class="consultation-tct-box">
                                            <div class="consultation-name"><?php echo e($doc_name); ?></div>
                                            <div class="consultation-date"><?php echo e($consult_datetime); ?></div>
                                            <div class="confirmed-msg">Completed</div>

                                            <div class="consu-drop-wrapper">
                                                <div class="ellipses-icon bg-img">&nbsp;</div>
                                                <div class="consu-drop">
                                                    <ul>
                                                        <li><a href="<?php echo e(url('/')); ?>/patient/my_consultation/completed/<?php echo e($id); ?>/online_waiting_room">Online Waiting Room</a></li>
                                                        <li><a href="<?php echo e(url('/')); ?>/patient/my_consultation/completed/<?php echo e($id); ?>/details">View Consultation Details</a></li>
                                                        <li><a href="<?php echo e(url('/')); ?>/patient/my_consultation/completed/<?php echo e($id); ?>/feedback_review">Feedback &amp; Review</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-4 grid_view" style="display: none;">
                                    <div class="patient-photo-bx">
                                        <div class="patient-image-new">
                                            <img src="<?php echo e($doc_img_src); ?>" alt="" />
                                        </div>
                                        <div class="patient-status-name"><?php echo e($doc_name); ?></div>
