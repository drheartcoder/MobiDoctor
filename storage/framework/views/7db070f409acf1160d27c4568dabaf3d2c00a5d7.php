               ...
               <table class="table table-advance"  id="blog-table" >
                  <thead>
                     <tr>
                        ...
                        <th width="15px">Is Investigation Details</th>
                  ...
                  <tbody>
                     ...
                     <?php
                        ...
                        $is_investigation_details = 'No';
                        if(isset($value['is_investigation_details']) && $value['is_investigation_details']!='' && $value['is_investigation_details']=='Yes')
                        {
                           $is_investigation_details = 'Yes';
                        }
                     ?>
                     <tr>
                        ...
                        <td><?php echo e($is_investigation_details); ?></td>
                        <td> 
                           <?php if($is_investigation_details == 'No'): ?>
                           ...
                           <?php else: ?>
                              <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="<?php echo e($module_url_path.'/view_details/'.base64_encode($value['category_id']).'/'.base64_encode($value['sub_category_id'])); ?>"  title="View Details">
                              <i class="fa fa-eye" ></i>
                              </a>  
                           <?php endif; ?>
                           &nbsp;  
                           <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="<?php echo e($module_url_path.'/delete/'.base64_encode($value['id'])); ?>" 
