...
<!--rating start-->  
<link rel=stylesheet type="text/css" href="<?php echo e(url('/')); ?>/public/front/css/star-rating.css" />
<script type="text/javascript" src="<?php echo e(url('/')); ?>/public/front/js/jquery.rating.js" ></script>   
<script type="text/javascript" src="<?php echo e(url('/')); ?>/public/front/js/star-rating.js" ></script> 
<!--rating end-->    
