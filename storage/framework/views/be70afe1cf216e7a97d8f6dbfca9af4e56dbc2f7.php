...
?>
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-md-9 col-lg-9">
                    <div class="white-wrapper prescription-wrapper online-consultation">
                        <h2>Online Waiting Room <span class="cons-id">Consultation ID: <?php echo e($consult_id); ?></span></h2>
                        <div class="prescription-section">
                            <div class="clock-wrapper">
                                <div class="clock-section relative-block">
                                    <div class="clock-block relative-block">
                                        <img src="<?php echo e(url('/')); ?>/public/front/images/clock-img.png" class="img-responsive" alt=""/>
                                    ...
                                    <div class="timing-section">
                                        <div class="timing-left">
                                            <b><?php echo e($booking_time); ?></b>
                                            <span><?php echo e($booking_date); ?></span>
                                        </div>
                                        <div class="check-img bg-img">&nbsp;</div>
                                        <div class="timing-right">
                                            <span>Consultation with <?php echo e($doc_name); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="<?php echo e(url('/')); ?>/public/moment/moment.js"></script>
	<script src="<?php echo e(url('/')); ?>/public/moment/moment-with-locales.js"></script>
    ...
    <script type="text/javascript">
		...
		{
			var user_sel_timezone = "<?php echo e($user_timezone); ?>";

			// Set the date we're counting down to
			var given_time = "<?php echo e($booking_datetime); ?>";
