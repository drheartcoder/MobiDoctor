...
<?php
    ...
    $consultation_date = isset($arr_consultation['date']) && !empty($arr_consultation['date']) ? $arr_consultation['date'] : '';
    $consultation_time = isset($arr_consultation['time']) && !empty($arr_consultation['time']) ? $arr_consultation['time'] : '';
    $consultation_datetime = convert_datetime( $consultation_date.''.$consultation_time, 'user', 'datetime' );

    $sp_name = isset($arr_consultation['subscription_plan']['name']) && !empty($arr_consultation['subscription_plan']['name']) ? $arr_consultation['subscription_plan']['name'] : '';
    $consultation_price = isset($arr_consultation['subscription_plan']['consultation_price']) && !empty($arr_consultation['subscription_plan']['consultation_price']) ? $arr_consultation['subscription_plan']['consultation_price'] : '';

    if( isset($arr_patient) && !empty($arr_patient) ):
        $patient_firstname = isset($arr_patient->first_name) && !empty($arr_patient->first_name) ? decrypt_value($arr_patient->first_name) : $user_firstname;
        $patient_lastname  = isset($arr_patient->last_name) && !empty($arr_patient->last_name) ? decrypt_value($arr_patient->last_name) : $user_lastname;
    else:
        $patient_firstname = $user_firstname;
        $patient_lastname  = $user_lastname;
    endif;
?>
    ...
    <div class="container">
        <div class="booking-step-wrapper full-width">
            ...
            <div class="booking-title text-center">
                <div class="row">
                    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        <a class="prev-arrow bg-img" href="<?php echo e($module_url_path.'/'.$session_consultation_id); ?>/time">&nbsp;</a>
                    </div>
            ...
            <div class="booking-content payemnt-section">
                ...
                <form method="post" name="consultation_payment_form" id="consultation_payment_form" action="<?php echo e(url('/')); ?>/patient/consultation/<?php echo e($session_consultation_id); ?>/payment/process" autocomplete="off" >
                    <?php echo e(csrf_field()); ?>


                    <input type="hidden" name="consultation_price" id="consultation_price" value="<?php echo e($consultation_price); ?>" />
                    ...
                    <div class="checkout-wrapper">
                            ...
                            <select id="stripe_card" name="stripe_card">
                                ...
                                <?php if( isset( $card_details ) && !empty( $card_details ) ): ?>
                                    <?php foreach( $card_details as $card ): ?>
                                        ...
                                        <option value="<?php echo e($card['id']); ?>" data-card_id="<?php echo e($card['card_id']); ?>" data-customer_id="<?php echo e($card['customer_id']); ?>" ><?php echo e($card_no); ?></option>
                        ...
                        <div class="form-group credit-card-hide">
                            <div class="row">
                                <div class="sm-3 col-md-3 col-lg-3">
                        ...
                        <button type="button" class="green-btn make-payement" id="btn_submit_consultation_payment_form">Make Payment</button>
                    </div>

                    <div class="payment-wrapper">
                        <h3><?php echo e($user_firstname.' '.$user_lastname); ?></h3>
                        
                        <div class="user-info">
                            <p><b>Appointment Time</b></p>
                            <p><?php echo e(date("H:i A, l, d F Y", strtotime($consultation_datetime))); ?></p>
                        </div>
                        
                        <div class="user-info">
                            <p><b>Patient</b></p>
                            <p><?php echo e($patient_firstname.' '.$patient_lastname); ?></p>
                        </div>

                        <div class="user-info">
                            <p><b>Subscription Plan</b></p>
                            <p><?php echo e($sp_name); ?></p>
                        </div>

                        <div class="user-info description">
                            <p><b>Consultation Price</b></p>
                            <p><?php echo e($consultation_price); ?> <i class="fa fa-eur"></i></p>
                        </div>
                        
                        <div class="total-block">
                            <p>Total</p>
                            <h2><?php echo e($consultation_price); ?> <i class="fa fa-eur"></i></h2>
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#btn_submit_consultation_payment_form").click(function()
        {
            form_validation();
        });
        ...
        $("#apply_code").click(function() {
            ...
            var consultation_price = "<?php echo e($consultation_price); ?>";
            ...
            if( $.trim( discount_code ) != '' )
            {
                ...
                $.ajax({
                    url        : '<?php echo e(url("/")); ?>/patient/consultation/<?php echo e($session_consultation_id); ?>/payment/apply_discount',
                    type       : 'post',
                    data       : { _token:token, discount_code:discount_code, consultation_price:consultation_price },
                    dataType   : 'json',
    ...
    function payment()
    {
        ...
        var form = $('#consultation_payment_form')[0];
        var formData = new FormData(form);

        $.ajax({
            url         : "<?php echo e(url('/')); ?>/patient/consultation/<?php echo e(Session::get('consultation_id')); ?>/payment/process",
            type        : 'post',
            data        : formData,
            processData : false,
            contentType : false,
            ...
            success     : function (res)
            {
                ...
                {
                    // reset form
                    $('#consultation_payment_form')[0].reset();
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "<?php echo e(url('/')); ?>/patient/consultation/<?php echo e(Session::get('consultation_id')); ?>/reason";
                    }, 6000);
                }
                else
                {
