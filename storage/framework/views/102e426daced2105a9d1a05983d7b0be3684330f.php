...
<div id="breadcrumbs">
   <ul class="breadcrumb">
      ...
      <li><i class="fa fa-list"></i><a href="<?php echo e($category_url_path); ?>"><?php echo e(isset($category_module_title) ? $category_module_title : ''); ?></a></li>
      <span class="divider">
      <i class="fa fa-angle-right"></i>
      </span> 
                    ...
                    <div class="form-group box_content">
                        ...
                        <div class="form-group">
                           <div class="col-sm-8 col-lg-8 controls">
                              ...
                              <span class='help-block'> <?php echo e($errors->first('common')); ?> </span> 
                    ...
                    <div class="form-group box_content">
                        ...
                        <div class="form-group">
                           <div class="col-sm-8 col-lg-8 controls">
                              ...
                              <span class='help-block'> <?php echo e($errors->first('causes')); ?> </span> 
                    ...
                    <div class="form-group box_content">
                        ...
                        <div class="form-group">
                           <div class="col-sm-8 col-lg-8 controls">
                              ...
                              <span class='help-block'> <?php echo e($errors->first('treatment_prevention')); ?> </span> 
