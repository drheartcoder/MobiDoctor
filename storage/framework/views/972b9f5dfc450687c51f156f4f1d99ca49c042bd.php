            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="pati-new-tab">
                    <ul>
                        ...
                        <li>
                            <a class="active" id="medical_certificate" href="<?php echo e($module_url_path); ?>/medical_certificate/<?php echo e($patient_user_id); ?>">Medical Certificate</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="content">
                    ...
                    <div class="white-wrapper prescription-wrapper history-wrapper">
                        ...
                        <form name="frm_medical_certificate" id="frm_medical_certificate" method="post" action="<?php echo e($module_url_path); ?>/medical_certificate/save_and_generate_medical_certificate">
                            <?php echo e(csrf_field()); ?>

                            <div class="prescription-section">
                                <div class="row">
                                    
                                    <input type="hidden" name="patient_id" value="<?php echo e(isset( $patient_user_id ) ? base64_decode( $patient_user_id ) : 0); ?>">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select id="family_member" name="family_member">
                                                ...
                                                ?>
                                                <option value="<?php echo e($patient_id); ?>" data-type="user"><?php echo e($patient_name); ?></option>
                                                
                                                <?php if(isset( $arr_family_member ) && sizeof( $arr_family_member )>0): ?>
                                                    <?php foreach($arr_family_member as $family_member): ?> 
                                                        <?php  
                                                        ...
                                                        ?>
                                                        <option value="<?php echo e($famili_member_id); ?>" data-type="family"><?php echo e($family_member_name); ?></option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-12">
                                        <div class="form-group">
                                            <select id="reason" name="reason">
                                                ...
                                                <?php if(isset($arr_reason) && sizeof($arr_reason)>0): ?>
                                                    <?php foreach($arr_reason as $reason): ?> 
...
<script type="text/javascript">
    $(document).ready(function()
    {
        var address     = '<?php echo e(isset($arr_doctor_details['doctor_data']['clinic_address']) ? $arr_doctor_details['doctor_data']['clinic_address'] : ''); ?>';
        var contact_no  = '<?php echo e(isset($arr_doctor_details['doctor_data']['clinic_contact_no']) ? $arr_doctor_details['doctor_data']['clinic_contact_no'] : ''); ?>';
