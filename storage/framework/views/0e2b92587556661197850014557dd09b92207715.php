...
<div class="page-wrapper doctor-signup-wrapper">
    <div class="container">
        <div class="doctor-signup-section">
            ...
            <form method="POST" name="patient_signup_form" id="patient_signup_form" autocomplete="off" action="<?php echo e(url('/')); ?>/patient/signup/store">
                ...
                <div class="doctor-signup-form">
                    ...
                    <div class="form-group country-block">
                        <input type="text" class="paddress" placeholder="Address" name="address" id="autocomplete" value="<?php echo e(isset($browser_address) ? $browser_address : ''); ?>" maxlength="300" />
