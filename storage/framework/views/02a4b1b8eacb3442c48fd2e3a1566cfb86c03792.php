                                ...
                                <table class="table">
                                    ...
                                    <?php foreach($arr_transactions['data'] as $key => $transactions): ?>    
                                        <tr>
                                            ...
                                            <td> <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="<?php echo e($module_url_path); ?>/subscription/view_transaction?id=<?php echo e(isset($transactions['id'])?base64_encode($transactions['id']):0); ?>"  title="View"><i class="fa fa-eye" ></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>    
                                    </tbody>
