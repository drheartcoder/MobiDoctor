...
<div class="page-wrapper">
    <div class="container">
        <div class="row">
            ...
            <form name="frm_patient_about_me" id="frm_patient_about_me" method="post" autocomplete="off" action="<?php echo e($module_url_path); ?>/about_me/update" enctype="multipart/form-data">
                    ...
                    <div class="white-wrapper">
                        ...
                        <div class="form-group profile-img-wrapper">
                            <div class="profile-img-block">
                                <div class="pro-img">
                                    <?php if(isset($arr_patient['profile_image']) && $arr_patient['profile_image']!=''): ?>
                                        <?php if(file_exists($profile_image_base_path.'/'.$arr_patient['profile_image'])): ?>
                                            <?php $profile_img_src = $profile_image_public_path.'/'.$arr_patient['profile_image']; ?>
                                        <?php else: ?>
                                    ...
                                    <?php if( $arr_patient['social_login'] == 'yes' ): ?>
                                        <?php $profile_img_src = $arr_patient['profile_image']; ?>
                                    <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                     ...
                                     <input type="text" placeholder="First Name" name="first_name" id="first_name" value="<?php echo e(isset($arr_patient['first_name'])?decrypt_value($arr_patient['first_name']):''); ?>" maxlength="15" />
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                     ...
                                     <input type="text" placeholder="Last Name" name="last_name" id="last_name" value="<?php echo e(isset($arr_patient['last_name'])?decrypt_value($arr_patient['last_name']):''); ?>" maxlength="15"/>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" readonly="" placeholder="Email" name="email" id="email" value="<?php echo e(isset($arr_patient['email'])?$arr_patient['email']:''); ?>" maxlength="80"/>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="date-input relative-block">
                                        <input class="date-input" id="datepicker" type="text" placeholder="Select Date of Birth" name="birth_date" value="<?php echo e(isset($arr_patient['date_of_birth']) ? date('m/d/Y',strtotime($arr_patient['date_of_birth'])) : ''); ?>" />
                        ...
                        <div class="row">
                                    ...
                                    <option value="">Code</option>
                                        <?php if(!empty($mobcode_data) && isset($mobcode_data)): ?>
                                            <?php foreach($mobcode_data as $mobcode): ?>
                                                <option value="<?php echo e($mobcode['phonecode']); ?>" <?php if($arr_patient['phone_code'] == $mobcode['phonecode']): ?> selected <?php endif; ?> >+<?php echo e($mobcode['phonecode']); ?> (<?php echo e($mobcode['iso3']); ?>)</option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Mobile Number" name="mobile_no" id="mobile_no" readonly maxlength="15" value="<?php echo e(isset($arr_patient['mobile_no'])?$arr_patient['mobile_no']:''); ?>" maxlength="16"/>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Contact Number" name="contact_no" id="contact_no" value="<?php echo e(isset($arr_patient['contact_no'])?$arr_patient['contact_no']:''); ?>" maxlength="16"/>
                                </div>
                            </div>  
                        </div>
                        <div class="form-group">
                            <label class="form-label">Address<i class="red">*</i></label>
                            <textarea placeholder="Address" name="address" id="autocomplete" rows="2"><?php echo e(isset($arr_patient['address'])?decrypt_value($arr_patient['address']):''); ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                 <div class="form-group">
                                     <label class="form-label">Country<i class="red">*</i></label>
                                     <input type="text" placeholder="Country" name="country" id="country" value="<?php echo e(isset($arr_patient['country'])?decrypt_value($arr_patient['country']):''); ?>" maxlength="50"/>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                 <div class="form-group">
                                     ...
                                     <input type="text" placeholder="City" id="locality" name="city" value="<?php echo e(isset($arr_patient['city'])?decrypt_value($arr_patient['city']):''); ?>" maxlength="50"/>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Fax" name="fax_no" id="fax_no" value="<?php echo e(isset($arr_patient['city'])?decrypt_value($arr_patient['fax_no']):''); ?>" maxlength="16"/>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="timezone" id="timezone">
                                    ...
                                    <?php if(isset($arr_timezone) && sizeof($arr_timezone)>0): ?>
                                        <?php foreach($arr_timezone as $timezone): ?>
                                            <option value="<?php echo e($timezone['id']); ?>" <?php if(isset($arr_patient['timezone']) && $arr_patient['timezone']!='' && $arr_patient['timezone'] == $timezone['id']): ?> selected <?php endif; ?>><?php echo e(isset($timezone['location_name'])?$timezone['location_name']:''); ?> (<?php echo e(isset($timezone['utc_offset'])?$timezone['utc_offset']:''); ?>)</option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="referral_code" id="referral_code" name="referral_code" placeholder="Referral code" readonly value="<?php echo e(isset($arr_patient['referral_code']) ? $arr_patient['referral_code'] : ''); ?>"/>
                                    <div class="error" id="err_referral_code"></div>
                                </div>
                            </div>
                        </div>
