                            ...
                            <ul>
                                <li>
                                    <div class="noti-block relative-block">
                                        <a class="noti-icon bg-img" href="<?php echo e(url('/')); ?>/patient/notification"></a>
...
<script type="text/javascript">
    ...
    {
        $.ajax({
            url      : "<?php echo e(url('/')); ?>/patient/my_consultation/upcoming/is_patient_get_call",
            type     : 'GET',
            data     : 'flag=true',
            dataType : 'json',
                ...
                if( response.status == 'success' && response.url != '')
                {
                    ...
                    function(isConfirm)
                    {
                        ...
                        else
                        {
                            ...
                            $.ajax({
                                url     : "<?php echo e(url('/')); ?>/patient/my_consultation/upcoming/patient_call_reject",
                                type    : "GET",
