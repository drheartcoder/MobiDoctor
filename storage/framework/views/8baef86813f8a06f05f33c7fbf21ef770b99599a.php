                      	...
                      	<?php if(isset($arr_consultation) && sizeof($arr_consultation)>0): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($payment); ?></td>
                      			<td>
                                    <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="<?php echo e($module_url_path.'/upcoming/details/'.base64_encode($data['id'])); ?>" title="Details"><i class="fa fa-eye" ></i></a>
                                </td>
                      		</tr>
