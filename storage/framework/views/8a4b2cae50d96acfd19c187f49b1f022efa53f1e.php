	...
	<div class="container">
		<div class="booking-step-wrapper full-width">
			...
			<div class="booking-title text-center">
				<div class="row">
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><a class="prev-arrow bg-img" href="<?php echo e(url('/')); ?>/patient/consultation/subscription_plan">&nbsp;</a></div>
			...
			<div class="booking-content payemnt-section">
				...
				<form method="post" name="subscription_plan_payment_form" id="subscription_plan_payment_form" action="<?php echo e(url('/')); ?>/patient/consultation/subscription_plan/payment/process" autocomplete="off" >
					<?php echo e(csrf_field()); ?>


					<input type="hidden" name="sp_price"       id="sp_price"       value="<?php echo e($sp_price); ?>" />
					...
					<div class="payment-wrapper">
						...
						<div class="total-block">
							<p>Total</p>
							<h2><i class="fa fa-eur"></i> <?php echo e($sp_price); ?></h2>
							<span id="discount_span" style="display: none;"><i class="fa fa-eur"></i> <b id="show_discount_price"></b> off</span>
						</div>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		$("#apply_code").click(function() {
            ...
            var sp_price      = "<?php echo e($sp_price); ?>";
            ...
            if( $.trim( discount_code ) != '' )
            {
                ...
                $.ajax({
                    url         : '<?php echo e(url("/")); ?>/patient/consultation/subscription_plan/payment/apply_discount',
                    type       : 'post',
	...
	function payment()
	{
        ...
        $.ajax({
            url         : '<?php echo e(url("/")); ?>/patient/consultation/subscription_plan/payment/process',
            type        : 'post',
            data        : formData,
            processData : false,
            contentType : false,
            ...
            success     : function (res)
            {
                ...
                if(res.status == 'success')
                {
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "<?php echo e(url('/')); ?>/patient/consultation/<?php echo e(Session::get('consultation_id')); ?>/patient";
                    }, 6000);
                }
                else
                {
