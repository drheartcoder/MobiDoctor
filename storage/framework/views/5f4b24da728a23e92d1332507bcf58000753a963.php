<?php $__env->startSection('main_content'); ?>
            ...
            <div class="row">
                ...
                <div class="my-consultation-wrapper row">
                    ...
                    <?php if( isset( $arr_consultation ) && !empty( $arr_consultation ) ): ?>
                        ...
                        <div id="hms"><?php echo e($patient_call_duration); ?></div>
    ...
    <script type="text/javascript">
        ...
        function join()
        {
            ...
            $.ajax({
                url     : "<?php echo e($module_url_path); ?>/upcoming/video/initiate_patient_call",
                type    : "GET",
        ...
        function leave() 
        {
            ...
            $.ajax({
                url     : "<?php echo e($module_url_path); ?>/upcoming/video/drop_patient_call",
                type    : "GET",
        ...
        function update_patient_call_duration()
        {
            ...
            $.ajax({
                url     : "<?php echo e($module_url_path); ?>/upcoming/video/update_patient_call_duration",
                type    : "GET",
                data    : { _token:token, consult_id:consult_id, call_timer:call_timer },
                success : function(res)
                {
