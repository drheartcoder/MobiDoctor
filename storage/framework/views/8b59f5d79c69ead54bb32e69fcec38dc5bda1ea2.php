                                        ...
                                        <div class="consultation-tct-box">
                                            ...
                                            <div class="consu-drop-wrapper">
                                                ...
                                                <div class="consu-drop">
                                                    <ul>
                                                        <li><a href="<?php echo e(url('/')); ?>/patient/my_consultation/upcoming/<?php echo e($id); ?>/online_waiting_room">Online Waiting Room</a></li>
                                                        <li><a href="<?php echo e(url('/')); ?>/patient/my_consultation/upcoming/<?php echo e($id); ?>/details">View Consultation Details</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
