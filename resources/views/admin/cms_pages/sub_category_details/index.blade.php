               ...
               <table class="table table-advance"  id="blog-table" >
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>{{$is_investigation_details}}</td>
                        <td> 
                           ...
                           @else
                              <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="{{ $module_url_path.'/view_details/'.base64_encode($value['category_id']).'/'.base64_encode($value['sub_category_id'])}}"  title="View Details">
                              <i class="fa fa-eye" ></i>
                              </a>  
                           @endif
                           &nbsp;  
                           <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="{{ $module_url_path.'/delete/'.base64_encode($value['id'])}}" 
