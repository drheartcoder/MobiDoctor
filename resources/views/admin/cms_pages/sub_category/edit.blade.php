...
<div id="breadcrumbs">
   <ul class="breadcrumb">
      ...
      <li><a href="{{$module_url_path}}/sub_category">{{ $module_title or ''}}</a></li>
      <span class="divider">
      <i class="fa fa-angle-right"></i>
...
<div class="col-md-12">
   <div class="box box-blue">
      ...
      <br/>
      <form method="post" action="{{url($module_url_path.'/sub_category/update/')}}{{base64_encode($arr_subcategory['id'])}}" id="validation-form" class="form-horizontal" enctype="multipart/form-data" name="Form" >
         {{ csrf_field() }}
               ...
               <div class="col-md-12">
                  ...
                  <div class="box-content">
                           ...
                           <select name="category_id" id="category_id" class="form-control">
                              ...
                              @if(isset($arr_category) && sizeof($arr_category)>0)
                                 @foreach($arr_category as $category)
                                    <option value="{{$category['id']}}" @if(isset($arr_subcategory['category_id']) && $arr_subcategory['category_id']!='' && $arr_subcategory['category_id'] == $category['id']) selected @endif>{{isset($category['name'])?decrypt_value($category['name']):''}}</option>
                                 @endforeach
                              @endif
                           </select>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-6 controls">
                           <input type="text" name="sub_category_name" class="form-control" id="sub_category_name" placeholder="Sub Category Name" value="{{isset($arr_subcategory['name'])?decrypt_value($arr_subcategory['name']):''}}">
                         ...
                         <div class="col-sm-6 col-lg-7 controls">
                             <div class="fileupload fileupload-new" data-provides="fileupload">
                                 ...
                                 <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                     @if(isset($arr_subcategory['image']) && !empty($arr_subcategory['image']) && $arr_subcategory['image'] != null && file_exists($sub_category_base_path.'/'.$arr_subcategory['image']))
                                         <?php $image = $arr_subcategory['image']; ?>                    
                                     <img src="{{ $sub_category_public_path.'/'.$arr_subcategory['image'] }}" id="preview" >
                                     @else
                                 ...
                                 <div>
                                     <span class="btn btn-default btn-file" style="height:32px;">
                                         ...
                                         <input type="hidden" class="file-input " name="oldimage" id="oldimage" value="{{ $arr_subcategory['image'] }}"/>
                                     </span>
                                 </div>
                                 <i class="red"> 
...
$('#valid').click(function(){
   ...
   else if($.trim(sub_category_name)=="")
   {
