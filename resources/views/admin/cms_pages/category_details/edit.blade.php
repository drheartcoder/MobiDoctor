                     ...
                     <br/>
                                ...
                                <select name="category_id" id="category_id" class="form-control" disabled>
                                  ...
                                  @if(isset($arr_category) && sizeof($arr_category)>0)
                                     @foreach($arr_category as $category)
                                        <option value="{{$category['id']}}" @if(isset($arr_category_details['category_id']) && $arr_category_details['category_id'] == $category['id']) selected @endif>{{isset($category['name'])?decrypt_value($category['name']):''}}</option>
                                     @endforeach
                                  @endif
                               </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-7 controls">
                               <input type="text" name="meta_title" class="form-control" id="meta_title" placeholder="Meta Title" value="{{isset($arr_category_details['meta_title'])?decrypt_value($arr_category_details['meta_title']):''}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-7 controls">
                            <input type="text" name="meta_keyword" class="form-control" id="meta_keyword" placeholder="Meta Keyword"  value="{{isset($arr_category_details['meta_keyword'])?decrypt_value($arr_category_details['meta_keyword']):''}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-7 controls">
                               <input type="text" name="meta_desc" class="form-control" id="metadesc" placeholder="Meta description" value="{{isset($arr_category_details['meta_desc'])?decrypt_value($arr_category_details['meta_desc']):''}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-7 controls">
                                <div class="radio-btn">
                                    <input class="is_investigation_details" type="radio" name="is_investigation_details" id="yes" value="Yes" @if(isset($arr_category_details['is_investigation_details']) && $arr_category_details['is_investigation_details']=='Yes') checked @endif/>Yes
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <input class="is_investigation_details" type="radio" name="is_investigation_details" id="no" value="No" @if(isset($arr_category_details['is_investigation_details']) && $arr_category_details['is_investigation_details']=='No') checked @endif/>No
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="form-group box_content">
                            ...
                            <div class="form-group">
                               <div class="col-sm-8 col-lg-8 controls">
                                  <textarea class='form-control desc' id='template_html1' name="common" rows='10' placeholder='Email Template Body'>{{isset($arr_category_details['common'])?decrypt_value($arr_category_details['common']):''}}</textarea>
                        ...
                        <div class="form-group box_content">
                            ...
                            <div class="form-group">
                            <div class="col-sm-8 col-lg-8 controls">
                              <textarea class='form-control desc' id='template_html2' name="symptoms" rows='10' placeholder='Email Template Body'>{{isset($arr_category_details['symptoms'])?decrypt_value($arr_category_details['symptoms']):''}}</textarea>
                        ...
                        <div class="form-group box_content">
                            ...
                            <div class="form-group">
                            <div class="col-sm-8 col-lg-8 controls">
                            <textarea class='form-control desc' id='template_html3' name="causes" rows='10' placeholder='Email Template Body'>{{isset($arr_category_details['causes'])?decrypt_value($arr_category_details['causes']):''}}</textarea>
                        ...
                        <div class="form-group box_content">
                            ...
                            <div class="form-group">
                               <div class="col-sm-8 col-lg-8 controls">
                                  <textarea class='form-control desc' id='template_html4' name="treatment_prevention" rows='10' placeholder='Email Template Body'>{{isset($arr_category_details['treatment_prevention'])?decrypt_value($arr_category_details['treatment_prevention']):''}}</textarea>
                        ...
                        <div class="form-group normal_page">
                            ...
                            <div class="form-group">
                               <div class="col-sm-8 col-lg-8 controls">
                                  <textarea class='form-control desc' id='template_html5' name="description" rows='10' placeholder='Email Template Body'>{{isset($arr_category_details['description'])?decrypt_value($arr_category_details['description']):''}}</textarea>
