    ...
    <div class="box">
        ...
        <div class="box-content">
          @include('admin.layout._operation_status')  
            ...
            <form method="post" class="form-horizontal" id="frm_manage" action="{{url($module_url_path.'/category/multi_action')}}">{{csrf_field()}}
                <div class="col-md-10">
                            ...
                            @if(isset($arr_category) && sizeof($arr_category)>0)
                                @foreach($arr_category as $category)
                                    <tr>
                                        ...
                                        <td> 
                                           <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="{{ $module_url_path.'/category/edit/'.base64_encode($category['id'])}}"  title="Edit">
