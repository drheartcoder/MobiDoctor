               ...
               {{ csrf_field() }}
                ...
                <div class="col-sm-6 col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-8 controls">
                            <input type="text" name="start_date" placeholder="Start Date" id="start_date" class="form-control datepicker" value="{{ isset($arr_discount_code['start_date']) ? date('Y-m-d',strtotime($arr_discount_code['start_date'])) : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-lg-8 controls">
                            <input type="text" name="end_date" placeholder="End Date" id="end_date" class="form-control datepicker" value="{{ isset($arr_discount_code['end_date']) ? date('Y-m-d',strtotime($arr_discount_code['end_date'])) : '' }}">
...
{
    var today = new Date();
    var end_date = '{{isset($arr_discount_code['end_date']) ? date('Y-m-d',strtotime($arr_discount_code['end_date'])) : ''}}';
