                ...
                <div class="box-content">
                    @include('admin.layout._operation_status')
                      ...
                      {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <input type="hidden" value="{{$profile_image_public_img_path.'default-profile.png'}}" id="default_image">
                                    <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                        @if(isset($arr_data['profile_pic']) && !empty($arr_data['profile_pic']) && $arr_data['profile_pic'] != null && file_exists($profile_image_base_img_path.$arr_data['profile_pic'] ))                    
                                        <img src="{{ $profile_image_public_img_path.$arr_data['profile_pic'] }}" id="preview" >
                                        @else
                                        <img src="{{ $profile_image_public_img_path.'default-profile.png' }}" id="preview" >                    
                                        @endif
                                    </div>
                                    ...
                                    <div>
                                        <span class="btn btn-default btn-file" style="height:32px;">
                                            ...
                                            <input type="hidden" class="file-input " name="oldimage" id="oldimage" value="{{ $arr_data['profile_pic'] }}"/>
                                        </span>
                                    </div>
                                    <i class="red"> 
                        ...
                        <input type="hidden" class="form-control" name="prev_image_url" id="prev_image_url" value="{{ $profile_image_public_img_path.$arr_data['profile_pic'] }}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                            <input type="text" name="first_name" id="first_name" value="{{ isset($arr_data['user_details']['first_name']) ? decrypt_value($arr_data['user_details']['first_name']) : '' }}" class="form-control" data-rule-required="true" data-rule-maxlength="255" placeholder="First Name">   
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                                <input type="text" name="last_name" id="last_name" value="{{ isset($arr_data['user_details']['last_name']) ?decrypt_value($arr_data['user_details']['last_name']): '' }}" class="form-control" data-rule-required="true" data-rule-maxlength="255" placeholder="Last Name">   
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                             <input type="text" name="email" id="email" value="{{ isset($admin_email) ? $admin_email : '' }}" class="form-control" data-rule-required="true" data-rule-email="true" data-rule-maxlength="255" placeholder="Email" readonly=""> 
