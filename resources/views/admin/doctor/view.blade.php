...
<script crossorigin="anonymous" src="{{ url('/') }}/public/virgil/virgil-sdk.min.js"></script>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                           {{isset($arr_doctor_details['doctor_prefix']['name'])?$arr_doctor_details['doctor_prefix']['name']:''}} {{ isset($arr_doctor_details['first_name']) ? decrypt_value($arr_doctor_details['first_name']) : '' }} {{ isset($arr_doctor_details['last_name']) ? decrypt_value($arr_doctor_details['last_name']) : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                             {{ isset($arr_doctor_details['email']) ? $arr_doctor_details['email'] : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                             {{ isset($arr_doctor_details['date_of_birth']) ? date('d M Y',strtotime($arr_doctor_details['date_of_birth'])) : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['phone_code']) ? '+'.$arr_doctor_details['phone_code'] : '' }}{{ isset($arr_doctor_details['mobile_no']) ? $arr_doctor_details['mobile_no'] : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['contact_no']) ? $arr_doctor_details['contact_no'] : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                             {{ isset($arr_doctor_details['gender']) ? $arr_doctor_details['gender'] : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['address']) ? decrypt_value($arr_doctor_details['address']) : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['city']) ? decrypt_value($arr_doctor_details['city']) : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['country']) ? decrypt_value($arr_doctor_details['country']) : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            @if(isset($arr_doctor_details['timezone_details']['location_name']) && $arr_doctor_details['timezone_details']['location_name']!='')
                                                {{$arr_doctor_details['timezone_details']['location_name']}}  ({{ isset($arr_doctor_details['timezone_details']['utc_offset']) ? $arr_doctor_details['timezone_details']['utc_offset'] : '' }})
                                            @else
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['social_login']) ? ucfirst($arr_doctor_details['social_login']) : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            @if(isset($arr_doctor_details['status']) && $arr_doctor_details['status'] != '' && $arr_doctor_details['status'] == '1')
                                                Active
                                            @else
                                                Inactive
                                            @endif
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            @if(isset($arr_doctor_details['is_email_verified']) && $arr_doctor_details['is_email_verified'] != '' && $arr_doctor_details['is_email_verified'] == '1')
                                                Verified
                                            @else
                                                Unverified
                                            @endif
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            @if(isset($arr_doctor_details['is_mobile_verified']) && $arr_doctor_details['is_mobile_verified'] != '' && $arr_doctor_details['is_mobile_verified'] == '1')
                                                Verified
                                            @else
                                                Unverified
                                            @endif
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['login_count']) ? $arr_doctor_details['login_count'] : '0' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ isset($arr_doctor_details['last_login']) ? date('d M Y h:i A', strtotime($arr_doctor_details['last_login'])) : '-' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                             {{ isset($arr_doctor_details['created_at']) ? date('d M Y' , strtotime($arr_doctor_details['created_at'])) : '' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                           @if( isset($arr_doctor_details['doctor_data']['admin_verified']) && $arr_doctor_details['doctor_data']['admin_verified'] != '' && $arr_doctor_details['doctor_data']['admin_verified'] == '1' )
                                                <a onclick="confirm_action(this,event,'Do you really want to unverified this doctor ?')" href="{{ $module_url_path.'/admin_unverified/'.base64_encode($arr_doctor_details['id']) }}" class="btn btn-success">Verified</a>
                                            @else
                                                <a onclick="confirm_action(this,event,'Do you really want to verified this doctor ?')" href="{{ $module_url_path.'/admin_verified/'.base64_encode($arr_doctor_details['id']) }}" class="btn btn-danger" {{ $disabled }} >Unverified</a>
                                             @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            @if(isset($arr_doctor_details['doctor_data']['experience']) && $arr_doctor_details['doctor_data']['experience']!='')

                                                {{  $arr_doctor_details['doctor_data']['experience'] }} Year(s)
                                            @else
                                        ...
                                        <div class="col-lg-8">
                                            <?php
                                                ...
                                                if(isset($driving_licence) && !empty($driving_licence) && File::exists($driving_base_path.'/'.$driving_licence)):
                                                    ...
                                                    ?>
                                                        <a id="dec_driving_licence" data-name="driving_licence" data-file="{{ $driving_licence }}" data-path="{{ $driving_file }}" href="" download>
                                        ...
                                        <div class="col-lg-8" id="medical_registration">
                                            <?php
                                                ...
                                                if(isset($medical_registration) && !empty($medical_registration) && File::exists($medical_reg_base_path.'/'.$medical_registration)):
                                                    ...
                                                    ?>
                                                        <a id="dec_medical_registration" data-name="medical_registration" data-file="{{ $medical_registration }}" data-path="{{ $medical_file }}" href="" download>
                                                            <p><span class="bg-img">&nbsp;</span>Download </p>
                                                        </a>
                                                    <?php
                                                endif;
...
$(document).ready(function(){
    ...
    var clinic_address     = '{{ isset($arr_doctor_details['doctor_data']['clinic_address']) ? $arr_doctor_details['doctor_data']['clinic_address'] : '' }}';
    var clinic_contact_no  = '{{ isset($arr_doctor_details['doctor_data']['clinic_contact_no']) ? $arr_doctor_details['doctor_data']['clinic_contact_no'] : '' }}';
    var clinic_mobile_no   = '{{ isset($arr_doctor_details['doctor_data']['clinic_mobile_no']) ? $arr_doctor_details['doctor_data']['clinic_mobile_no'] : '' }}';
    var clinic_email       = '{{ isset($arr_doctor_details['doctor_data']['clinic_email']) ? $arr_doctor_details['doctor_data']['clinic_email'] : '' }}';
    var clinic_phone_code  = '{{ isset($arr_doctor_details['doctor_data']['clinic_phone_code']) ? $arr_doctor_details['doctor_data']['clinic_phone_code'] : '' }}';
    ...
    var bank_name         = '{{isset($arr_doctor_details['doctor_data']['bank_name'])?$arr_doctor_details['doctor_data']['bank_name']:''}}';
    var bank_account_name = '{{isset($arr_doctor_details['doctor_data']['bank_account_name'])?$arr_doctor_details['doctor_data']['bank_account_name']:''}}';
    var bank_account_no   = '{{isset($arr_doctor_details['doctor_data']['bank_account_no'])?$arr_doctor_details['doctor_data']['bank_account_no']:''}}';
    ...
    var medical_qualification = '{{ isset($arr_doctor_details['doctor_data']['medical_qualification']) ? $arr_doctor_details['doctor_data']['medical_qualification'] : '' }}';
    var medical_school        = '{{ isset($arr_doctor_details['doctor_data']['medical_school'])        ? $arr_doctor_details['doctor_data']['medical_school']        : '' }}';
    var year_obtained         = '{{ isset($arr_doctor_details['doctor_data']['year_obtained'])         ? $arr_doctor_details['doctor_data']['year_obtained']         : '' }}';
    var country_obtained      = '{{ isset($arr_doctor_details['doctor_data']['country_obtained'])      ? $arr_doctor_details['doctor_data']['country_obtained']      : '' }}';
    var other_qualifications  = '{{ isset($arr_doctor_details['doctor_data']['other_qualifications'])  ? $arr_doctor_details['doctor_data']['other_qualifications']  : '' }}';
    ...
    var prescriber_no         = '{{ isset($arr_doctor_details['doctor_data']['prescriber_no']) ? $arr_doctor_details['doctor_data']['prescriber_no'] : '' }}';
    var ahpra_registration_no = '{{ isset($arr_doctor_details['doctor_data']['ahpra_registration_no']) ? $arr_doctor_details['doctor_data']['ahpra_registration_no'] : '' }}';

    var medical_registration = '{{ isset($arr_doctor_details['doctor_data']['medical_registration']) ? $arr_doctor_details['doctor_data']['medical_registration'] : '' }}';
...
function decrypt(enctext)
{
    ...
    if( $.trim(enctext) != '' )
    {
        var userkey = "{{ $arr_doctor_details['dump_session'] or ''}}";
