...
<div id="breadcrumbs">
  <ul class="breadcrumb">
    ...
    <span class="divider">
      <i class="fa fa-angle-right"></i>
      <a href="{{ $module_url_path.'/completed' }}">{{ $previous_page or ''}}</a>
    </span> 
    <span class="divider">
      <i class="fa fa-angle-right"></i>
      <i class="fa fa-eye"></i>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">
                                            {{ $doctor_prefix.'. '.$doctor_fname.' '.$doctor_lname }}
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-8">
                                            <?php
                                                if(isset($illness_image) && !empty($illness_image) && File::exists($illness_image_base_path.'/'.$illness_image)):
                                                    ...
                                                    ?>
                                                        <a id="dec_illness_image" data-name="illness_image" data-file="{{ $illness_image }}" data-path="{{ $illness_file }}" href="" download>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <div class="col-lg-8">{{ $user_fname.' '.$user_lname }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Email :</label>
                                        <div class="col-lg-8">{{ $user_email }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Date of Birth :</label>
                                        <div class="col-lg-8">{{ $user_dob }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Mobile No. :</label>
                                        <div class="col-lg-8">{{ $user_phone_code.''.$user_mobile_no }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Contact No. :</label>
                                        <div class="col-lg-8">{{ $user_contact_no }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Gender :</label>
                                        <div class="col-lg-8">{{ $user_gender }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Address :</label>
                                        <div class="col-lg-8">{{ $user_address }}</div>
                                    </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Name :</label>
                                        <div class="col-lg-8">{{ $doctor_prefix.'. '.$doctor_fname.' '.$doctor_lname }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Email :</label>
                                        <div class="col-lg-8">{{ $doctor_email }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Date of Birth :</label>
                                        <div class="col-lg-8">{{ $doctor_dob }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Mobile No. :</label>
                                        <div class="col-lg-8">{{ $doctor_phone_code.''.$doctor_mobile_no }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Contact No. :</label>
                                        <div class="col-lg-8">{{ $doctor_contact_no }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Gender :</label>
                                        <div class="col-lg-8">{{ $doctor_gender }}</div>
                                    </div>

                                    <div class="form-group col-sm-12">
                                        <label class="col-lg-4 control-label">Address :</label>
                                        <div class="col-lg-8">{{ $doctor_address }}</div>
                                    </div>
