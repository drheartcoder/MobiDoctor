...
<body>
            ...
            <div class="banner-content">
                ...
                <div class="mobi-appoint-btn">
                    ...
                    @elseif($user_type == 'patient')
                        <a href="{{url('/')}}/patient/consultation">Book Online Appointment</a>
                    @else
                        <a href="#login_modal" data-toggle="modal">Book Online Appointment</a>
                    @endif
                </div>
                ...
                <div class="mobi-appoint-btn mobi-how-work">
                    <a href="{{url('/')}}/how_it_work">How it Work</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-7 col-lg-7">
                        <div class="membership-content">
                            ...
                            <a class="green-btn" href="{{url('/')}}/membership">Find Out More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="member-ship-section-bx">
                    <div class="col-sm-6 col-md-6 col-lg-4 col-lg-offset-2  ">
                        <div class="month-membership-bx">
                            <div class="your-member-bx">
                                <div class="your-member-title">{{isset($arr_subscription_plan[0]['name'])?$arr_subscription_plan[0]['name']:''}}</div>
                                <div class="clearfix"></div>
                                <div class="member-ship-price">{{ isset($arr_subscription_plan[0]['consultation_price']) ? $arr_subscription_plan[0]['consultation_price'].'&#128;' : '' }}
                                    <h3>per consultation</h3>
                                </div>
                                <div class="member-ship-price">{{ isset($arr_subscription_plan[0]['monthly_price']) ? $arr_subscription_plan[0]['monthly_price'].'&#128;' : '' }}
                                    <h3>per month</h3>
                                </div>
                            </div>
                            <div class="membership-description">
                                <ul>
                                    <li>Prescription fee <span>{{ isset($arr_subscription_plan[0]['prescription_fee']) ? $arr_subscription_plan[0]['prescription_fee'].'&#128;' : '' }}</span></li>
                                    <li>Sicknote <span>{{ isset($arr_subscription_plan[0]['sick_note']) ? $arr_subscription_plan[0]['sick_note'].'&#128;' : '' }}</span></li>
                                    <li>Referrals <span>{{ isset($arr_subscription_plan[0]['referrals']) ? $arr_subscription_plan[0]['referrals'].'&#128;' : '' }}</span></li>
                                    <li>Membership discounts <span>@if(isset($arr_subscription_plan[0]['is_membership_discount']) && $arr_subscription_plan[0]['is_membership_discount'] == 'Yes') <i class="fa fa-check"></i> @else <i class="fa fa-times"></i>@endif</span></li>
                                </ul>
                            </div>
                            <div class="member-book-btn">
                                ...
                                @elseif($user_type == 'patient')
                                    <a class="book-now-btn" href="{{url('/')}}/patient/consultation">Become a member</a>
                                @else
                                    <a class="book-now-btn" href="#login_modal" data-toggle="modal">Become a member</a>
                                @endif
                            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="month-membership-bx member-block">
                            <div class="your-member-bx">
                                <div class="your-member-title">{{ isset($arr_subscription_plan[1]['name']) ? $arr_subscription_plan[1]['name'] : '' }}</div>
                                <div class="member-ship-price">{{ isset($arr_subscription_plan[1]['consultation_price']) ? $arr_subscription_plan[1]['consultation_price'].'&#128;' : '' }}
                                    <h3>per consultation</h3>
                                </div>
                                <div class="member-ship-price">{{ isset($arr_subscription_plan[1]['monthly_price']) ? $arr_subscription_plan[1]['monthly_price'].'&#128;' : '' }}
                                    <h3>per month</h3>
                                </div>
                            </div>
                            ...
                            <div class="membership-description">
                                <ul>
                                    <li>Prescription fee <span>{{ isset($arr_subscription_plan[1]['prescription_fee']) ? $arr_subscription_plan[1]['prescription_fee'].'&#128;' : '' }}</span></li>
                                    <li>Sicknote <span>{{ isset($arr_subscription_plan[1]['sick_note']) ? $arr_subscription_plan[1]['sick_note'].'&#128;' : '' }}</span></li>
                                    <li>Referrals <span>{{ isset($arr_subscription_plan[1]['referrals']) ? $arr_subscription_plan[1]['referrals'].'&#128;' : '' }}</span></li>
                                    <li>Membership discounts <span>@if(isset($arr_subscription_plan[0]['is_membership_discount']) && $arr_subscription_plan[0]['is_membership_discount'] == 'No') <i class="fa fa-times"></i> @else <i class="fa fa-times"></i>@endif</span></li>
                                </ul>
                            </div>
                            <div class="member-book-btn">
                                @if(!$is_valid_user_login)
                                ...
                                @elseif($user_type == 'patient')
                                    <a class="book-now-btn" href="{{url('/')}}/patient/consultation">Book an appointment</a>
                                @else
                                    <a class="book-now-btn" href="#login_modal" data-toggle="modal">Book an appointment</a>
                                @endif
                            </div>
    ...
    <div class="online-doctor-section home-section">
        <div class="container">
            ...
            @elseif($user_type == 'patient')
                <a class="green-btn" href="{{url('/')}}/patient/consultation">See Doctor Online</a>
            @else
                <a href="#login_modal" data-toggle="modal" class="green-btn">See Doctor Online</a>
            @endif
    ...
    @if(!$is_valid_user_login || $user_type == 'doctor')
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="appointment-frm">
                        ...
                        <form method="POST" name="hpatient_signup_form" id="hpatient_signup_form" autocomplete="off" action="{{ url('/') }}/patient/signup/store">
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-sm-12">
                                        <div class="form-group i-size lock-size">
                                            ...
                                            <input type="text" class="haddress" placeholder="Address" name="address" id="autocomplete" value="{{ $browser_address or '' }}" maxlength="300" />
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="make-appointment-img">
                        <img src="{{ url('/') }}/public/front/images/appoint.png" alt="app" />
                    </div>
