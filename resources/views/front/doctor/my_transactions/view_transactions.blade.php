            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="white-wrapper prescription-wrapper">
                    ...
                    <form name="frm_contact_us" id="frm_contact_us" method="post" action="{{ $module_url_path }}/contact_us/store">
                        {{csrf_field()}}
                        <div class="prescription-section contact-section table-setting">
                            <table>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td> {{isset($arr_transactions['consultation_id'])?$arr_transactions['consultation_id']:'-'}} </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td> {{isset($arr_transactions['amount'])?$arr_transactions['amount']:0.00}} </td>
                                </tr>
                                <tr>
