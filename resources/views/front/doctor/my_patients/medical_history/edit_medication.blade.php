        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="white-wrapper prescription-wrapper">
                    <h2>{{$page_title or ''}}</h2>
                    <form name="frm_update_medication" id="frm_update_medication" method="post" action="{{$module_url_path}}/medical_history/medication/update" enctype="multipart/form-data">
                        {{csrf_field()}}
...
<script type="text/javascript">
    var card_id = "{{ $patient_dump['dump_id'] or '' }}";
    var userkey = "{{ $patient_dump['dump_session'] or ''}}";
</script>
    ...
    $("#btn_update_medication").click(function(){
        ...
        else
        {
            ...
            api.cards.get(card_id).then(function (cards)
            {
                ...
                formData.append('enc_id',enc_id);

                $.ajax({
                    url         : "{{ $module_url_path }}/medical_history/medication/update",
                    type        : 'post',
                    data        : formData,
                    processData : false,
                    contentType : false,
