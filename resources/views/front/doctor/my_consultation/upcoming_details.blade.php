	...
	<div class="page-wrapper">
		<div class="container">
			<div class="consultation-back-page">
				<a href="{{ $module_url_path }}/upcoming">Back</a>
			</div>
			...
			<div class="row">
                                    ...
                                    @foreach( $arr_prescription as $key => $prescription )
                                        ...
                                        <div class="prescrip-pdf-strip ">
                                            <div class="presciption-name">
                                                <span id="dec_name{{ $key }}">{{ $name }}</span>
                                                <span id="dec_repeats{{ $key }}"></span>
                                                <span id="dec_direction{{ $key }}"></span>
                                            </div>
                                            <div class="presciption-view-dlt-bx">
                                                <div class="presciption-view-icon"><a id="dec_prescription_image{{ $key }}" data-name="prescription_image{{ $key }}" data-file="{{ $name }}" data-path="{{ $prescription_image }}" href="" download><i class="fa fa-download"></i></a></div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function(){
                                                $("#dec_repeats{{ $key }}").html( decrypt( "{{ $repeats }}" ) );
                                                $("#dec_direction{{ $key }}").html( decrypt( "{{ $direction }}" ) );

                                                if( $("#dec_prescription_image{{ $key }}").length )
                                                {
                                                    var name = $("#dec_prescription_image{{ $key }}").data('name');
                                                    var file = $("#dec_prescription_image{{ $key }}").data('file');
                                                    var path = $("#dec_prescription_image{{ $key }}").data('path');
                                ...
                                @if( isset( $arr_prescription ) && !empty( $arr_prescription ) )
                                    <div class="prescrip-pdf-section">
                                        @foreach( $arr_prescription as $key => $prescription )
                                            ...
                                            <div class="prescrip-pdf-strip ">
                                                <div class="presciption-name">
                                                    <span id="dec_edit_name{{ $key }}">{{ $name }}</span>
                                                    <span id="dec_edit_repeats{{ $key }}"></span>
                                                    <span id="dec_edit_direction{{ $key }}"></span>
                                                </div>
                                                <div class="presciption-view-dlt-bx">
                                                    <div class="presciption-view-icon"><a id="dec_edit_prescription_image{{ $key }}" data-name="edit_prescription_image{{ $key }}" data-file="{{ $name }}" data-path="{{ $prescription_image }}" href="" download><i class="fa fa-download"></i></a></div>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                            ...
                                            <script type="text/javascript">
                                                $(document).ready(function(){
                                                    $("#dec_edit_repeats{{ $key }}").html( decrypt( "{{ $repeats }}" ) );
                                                    $("#dec_edit_direction{{ $key }}").html( decrypt( "{{ $direction }}" ) );

                                                    if( $("#dec_edit_prescription_image{{ $key }}").length )
                                                    {
                                                        var name = $("#dec_edit_prescription_image{{ $key }}").data('name');
                                                        var file = $("#dec_edit_prescription_image{{ $key }}").data('file');
                                                        var path = $("#dec_edit_prescription_image{{ $key }}").data('path');
                ...
                <div class="col-sm-4 col-md-3 col-lg-3">
                    <div class="upcoming-consultation-details-box right-date">
                        ...
                        @if( $doctor_call_duration != '00:00:00' && $patient_call_duration != '00:00:00' )
                            <div class="video-consult-btn">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            ...
            $("#generate_invoice").click(function(){
                ...
                $.ajax({
                    url         : "{{ $current_url_path }}/generate_invoice",
                    type        : 'post',
