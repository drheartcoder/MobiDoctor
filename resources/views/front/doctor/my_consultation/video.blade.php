                    ...
                    @if( isset( $arr_consultation ) && !empty( $arr_consultation ) )
                        ...
                        <div id="video" style="margin:0 auto;">
                            ...
                            <div class="big-vdo-bx" id="agora_remote" style="float:left; width:100% ;height:607px;display:inline-block;"></div>
                                 ...
                                 <div class="vdo-main-time" id="hms">{{ $doctor_call_duration }}</div>
...
<!--                                <button id="stop_camera" class="btn btn-primary" onclick="disableVideo()">Stop Camera</button>-->
    ...
    <script type="text/javascript">
        ...
        function join()
        {
            ...
            $.ajax({
                url     : "{{ $module_url_path }}/upcoming/video/initiate_doctor_call",
                type    : "GET",
        ...
        function leave()
        {
            ...
            $.ajax({
                url     : "{{ $module_url_path }}/upcoming/video/drop_doctor_call",
                type    : "GET",
        ...
        function update_doctor_call_duration()
        {
            ...
            $.ajax({
                url     : "{{ $module_url_path }}/upcoming/video/update_doctor_call_duration",
                type    : "GET",
                data    : { _token:token, consult_id:consult_id, call_timer:call_timer },
                success : function(res)
                {
