            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="white-wrapper prescription-wrapper">
                    <h2>Bank Account Details</h2>
                     <form name="frm_medical_qualification" id="frm_medical_qualification" method="post" action="{{$module_url_path}}/bank_details/update">
                        {{csrf_field()}}
    ...
    $("#btn_bank_details").click(function(){
        ...
        else
        {
            ...
            api.cards.get(card_id).then(function (cards)
            {
                ...
                $.ajax({
                    url  : "{{ $module_url_path }}/bank_details/update",
                    type : 'post',
                    data : {
                                _token            : _token,
