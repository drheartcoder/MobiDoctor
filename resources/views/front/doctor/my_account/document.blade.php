        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="white-wrapper prescription-wrapper">
                    ...
                    <form name="frm_document_verification" id="frm_document_verification" method="post" action="{{ $module_url_path }}/document_verification/update" enctype="multipart/form-data">
                        <div class="prescription-section">
                            ...
                            <div class="document-upload-block">
                                ...
                                ?>
                                <input type="hidden" id="old_file_driving_licence" name="old_file_driving_licence" value="{{$driving_licence}}">
                            ...
                            <div class="document-upload-block">
                                ...
                                ?>
                                <input type="hidden" id="old_file_medical_registration" name="old_file_medical_registration" value="{{$medical_registration}}">
...
<script type="text/javascript">
    $(document).ready(function(){
        var medicare_provider_no  = '{{ isset($arr_doctor_details['medicare_provider_no']) ? $arr_doctor_details['medicare_provider_no'] : '' }}';
        var prescriber_no         = '{{ isset($arr_doctor_details['prescriber_no']) ? $arr_doctor_details['prescriber_no'] : '' }}';
        var ahpra_registration_no = '{{ isset($arr_doctor_details['ahpra_registration_no']) ? $arr_doctor_details['ahpra_registration_no'] : '' }}';
        ...
        $("#btn_document_verification").click(function()
        {
            ...
            else
            {
                ...
                api.cards.get(card_id).then(function (cards)
                {
                    ...
                    $.ajax({
                        url         : "{{ $module_url_path }}/document_verification/update",
                        type        : 'post',
                        data        : formData,
                        processData : false,
                        contentType : false,
