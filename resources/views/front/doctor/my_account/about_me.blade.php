    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <form name="frm_doctor_about_me" id="frm_doctor_about_me" method="post" autocomplete="off" action="{{ $module_url_path }}/about_me/update" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="prescription-section">
                    	<div class="form-group profile-img-wrapper">
                            <div class="profile-img-block">
                                <div class="pro-img">
                                    ...
                                    @if(isset($arr_doctor['profile_image']) && $arr_doctor['profile_image'] != '')
                                        @if(file_exists($profile_image_base_path.'/'.$arr_doctor['profile_image']))
                         ...
                         <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" id="first_name" placeholder="Enter First Name" maxlength="20" value="{{ isset($arr_doctor['first_name']) ? decrypt_value($arr_doctor['first_name']) : '' }}"/>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" id="last_name" placeholder="Enter Last Name" maxlength="20" value="{{ isset($arr_doctor['last_name']) ? decrypt_value($arr_doctor['last_name']) : '' }}"/>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="Enter Email" readonly maxlength="25" value="{{ isset($arr_doctor['email']) ? $arr_doctor['email'] : '' }}"/>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <div class="date-input relative-block">
                                        <input class="date-input" id="datepicker" type="text" placeholder="Select Date of Birth" name="birth_date" value="{{ isset($arr_doctor['date_of_birth']) ? date('m/d/Y',strtotime($arr_doctor['date_of_birth'])) : '' }}"/>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_no" id="contact_no" placeholder="Enter Contact Number" value="{{ isset($arr_doctor['contact_no']) ? $arr_doctor['contact_no'] : '' }}"/>
                                    ...
                                    <option value="">Code</option>
                                        @if(!empty($mobcode_data) && isset($mobcode_data))
                                            @foreach($mobcode_data as $mobcode)
                                                <option value="{{ $mobcode['phonecode'] }}" @if($arr_doctor['phone_code'] == $mobcode['phonecode']) selected @endif >+{{ $mobcode['phonecode'] }} ({{ $mobcode['iso3'] }})</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Mobile Number" name="mobile_no" id="mobile_no" readonly maxlength="15" value="{{ isset($arr_doctor['mobile_no']) ? $arr_doctor['mobile_no'] : '' }}"/>
                                    ...
                                    <select name="prefix" id="prefix">
                                        ...
                                        @if(isset($arr_prefix) && sizeof($arr_prefix)>0)
                                            @foreach($arr_prefix as $prefix)
                                                <option value="{{ $prefix['id'] }}" @if(isset($arr_doctor['prefix']) && $arr_doctor['prefix']!='' && $arr_doctor['prefix'] == $prefix['id']) selected @endif>{{ isset($prefix['name']) ? $prefix['name'] : '' }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select name="timezone" id="timezone">
                                        ...
                                        @if(isset($arr_timezone) && sizeof($arr_timezone)>0)
                                            @foreach($arr_timezone as $timezone)
                                                <option value="{{$timezone['id']}}"  @if(isset($arr_doctor['timezone']) && $arr_doctor['timezone']!='' && $arr_doctor['timezone'] == $timezone['id']) selected @endif>{{isset($timezone['location_name'])?$timezone['location_name']:''}} ({{isset($timezone['utc_offset'])?$timezone['utc_offset']:''}})</option>
                                            @endforeach
                                        @endif
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="Address" name="address" id="autocomplete" rows="2">{{ isset($arr_doctor['address']) ? decrypt_value($arr_doctor['address']) : '' }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Country" name="country" id="country" value="{{ isset($arr_doctor['country']) ? decrypt_value($arr_doctor['country']) : '' }}" maxlength="50"/>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="City" id="locality" name="city"  maxlength="50" value="{{ isset($arr_doctor['city']) ? decrypt_value($arr_doctor['city']) : '' }}"/>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="referral_code" id="referral_code" name="referral_code" placeholder="Referral code" readonly value="{{ isset($arr_doctor['referral_code']) ? $arr_doctor['referral_code'] : '' }}"/>
