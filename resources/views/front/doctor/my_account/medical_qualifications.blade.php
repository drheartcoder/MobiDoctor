            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="white-wrapper prescription-wrapper">
                    <h2>Medical Qualifications</h2>
                     <form name="frm_medical_qualification" id="frm_medical_qualification" method="post" action="{{ $module_url_path }}/medical_qualifications/update">
                        {{ csrf_field() }}
                            ...
                            <div class="row">
                                 <div class="col-sm-12 col-md-6 col-lg-6">
                                     <div class="form-group">
                                         ...
                                         <input type="text" name="year_obtained" id="year_obtained" placeholder="Ex. {{date('Y')}}" maxlength="4"/>
...
<script type="text/javascript">
    $(document).ready(function(){
        var medical_qualification = '{{ isset($arr_doctor_details['medical_qualification']) ? $arr_doctor_details['medical_qualification'] : '' }}';
        var medical_school        = '{{ isset($arr_doctor_details['medical_school'])        ? $arr_doctor_details['medical_school']        : '' }}';
        var year_obtained         = '{{ isset($arr_doctor_details['year_obtained'])         ? $arr_doctor_details['year_obtained']         : '' }}';
        var country_obtained      = '{{ isset($arr_doctor_details['country_obtained'])      ? $arr_doctor_details['country_obtained']      : '' }}';
        var other_qualifications  = '{{ isset($arr_doctor_details['other_qualifications'])  ? $arr_doctor_details['other_qualifications']  : '' }}';
    ...
    $("#btn_medical_qulification").click(function(){
        ...
        else
        {
            ...
            api.cards.get(card_id).then(function (cards)
            {
                ...
                $.ajax({
                    url  : "{{ $module_url_path }}/medical_qualifications/update",
                    type : 'post',
                    data : {
                                _token                : _token,
