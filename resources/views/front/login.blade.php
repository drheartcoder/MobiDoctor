    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" name="login_form" id="login_form" action="{{ url('/') }}/login">
                    {{ csrf_field() }}

                    <div class="form-group">
                        <input type="text" placeholder="Email Address" name="email" id="email" maxlength="80" value="{{ isset($_COOKIE['remember_me_email']) && !empty($_COOKIE['remember_me_email']) ? $_COOKIE['remember_me_email'] : '' }}" />
                        <div class="error" id="err_email"></div>
                    </div>

                    <div class="form-group">
                        <input type="password" class="pwd-field" placeholder="Password" name="password" id="password" maxlength="20" value="{{ isset($_COOKIE['remember_me_password']) && !empty($_COOKIE['remember_me_password']) ? $_COOKIE['remember_me_password'] : '' }}" />
...
<script type="text/javascript">
                    ...
                    success     : function (res)
                    {
                        ...
                        if(res.status == 'success')
                        {
                            ...
                            setTimeout(function() {
                                ...
                                window.location.href = "{{ url('/') }}/"+res.usertype+"/dashboard";
                            }, 500);
                        }
                        else
                        {
    ...
    function FBLogout()
    {
        ...
        {
            window.location.href = '{{ url("/") }}/patient/logout';
        });
    }(function(d, s, id) 
    {
