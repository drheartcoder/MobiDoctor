            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="white-wrapper prescription-wrapper edit-card-form">
                    ...
                    <div class="prescription-section">
                        <form name="frm_update_family_member" id="frm_update_family_member" method="post" action="{{$module_url_path}}/family_member/update/{{isset($arr_member_details['id'])?base64_encode($arr_member_details['id']):''}}">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label">First Name<i class="red">*</i></label>
                                        <input type="text" id="first_name" name="first_name" value="{{isset($arr_member_details['first_name'])?decrypt_value($arr_member_details['first_name']):''}}" placeholder="Enter First Name" maxlength="50" />
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="last_name" name="last_name" value="{{isset($arr_member_details['last_name'])?decrypt_value($arr_member_details['last_name']):''}}" placeholder="Enter Last Name" maxlength="50"/>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="email" value="{{isset($arr_member_details['email'])?$arr_member_details['email']:''}}" placeholder="Enter Email" maxlength="80"/>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="relation" name="relation" value="{{isset($arr_member_details['relation'])?decrypt_value($arr_member_details['relation']):''}}" placeholder="Enter Relationship" maxlength="50"/>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="date-input relative-block">
                                            <input class="date-input" name="birth_date" value="{{isset($arr_member_details['birth_date'])?date('m/d/Y',strtotime($arr_member_details['birth_date'])):''}}" id="datepicker" type="text" placeholder="Select Date of Birth"/>
                                        ...
                                        <option value="">Code</option>
                                            @if(!empty($mobcode_data) && isset($mobcode_data))
                                                @foreach($mobcode_data as $mobcode)
                                                    <option value="{{ $mobcode['phonecode'] }}" @if(isset($arr_member_details['phone_code']) && $arr_member_details['phone_code']!='' && $arr_member_details['phone_code'] == $mobcode['phonecode']) selected @endif>+{{ $mobcode['phonecode'] }} ({{ $mobcode['iso3'] }})</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Mobile no." id="mobile_no" name="mobile_no" value="{{isset($arr_member_details['mobile_no'])?$arr_member_details['mobile_no']:''}}" />
...
$('#btn_update_member').click(function(){
    ...
    else
    {
        ...
        $.ajax({
            url         : '{{ $module_url_path }}/family_member/update/{{base64_encode($arr_member_details['id'])}}',
            type        : 'post',
            data        : formData,
            processData : false,
            contentType : false,
