    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="row">
                    @if(isset($arr_member) && sizeof($arr_member)>0)
                        @foreach($arr_member as $key => $member)
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="payment-card family-card">
                                    <h4><b>{{ isset($member['first_name']) ? decrypt_value($member['first_name']) : '' }} {{ isset($member['last_name']) ? decrypt_value($member['last_name']) : '' }}
                                    </b> 
                                    <a class="edit-card" href="{{ $module_url_path }}/family_member/edit/{{ base64_encode($member['id']) }}"><i class="fa fa-pencil-square-o"></i></a></h4>
                                    <div class="payment-card-details">
                                        <div class="lifestyle-details">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="lifestyle-desc">{{ isset($member['gender']) ? decrypt_value($member['gender']) : '' }}</span>
                                                </li>
                                                <li>
                                                    <span class="lifestyle-label">Relationship</span>
                                                    <span class="lifestyle-desc">{{ isset($member['relation']) ? decrypt_value($member['relation']) : '' }}</span>
                                                </li>
                                                <li>
                                                    <span class="lifestyle-label">Date of Birth</span>
                                                    <span class="lifestyle-desc">{{ isset($member['birth_date']) ? $member['birth_date'] : '' }}</span>
                                                </li>
                                                <li>
                                        ...
                                        <a onclick="confirm_action(this,event,'Do you really want to remove this member ?')" href="{{ $module_url_path.'/family_member/remove/'.base64_encode($member['id']) }}" class="green-trans-btn full-width">Remove Member</a>
                ...
                <div class="white-wrapper prescription-wrapper add-card-form">
                    <h2>Add a Member</h2>
                    <form name="frm_add_family_member" id="frm_add_family_member" method="post" action="{{ $module_url_path }}/family_member/add">
                        {{csrf_field()}}
...
<script>
    ...
    function AddMemberValidationCheck()
    {
        ...
        else
        {
            ...
            $.ajax({
                url         : '{{ $module_url_path }}/family_member/add',
                type        : 'post',
                data        : formData,
                processData : false,
                contentType : false,
