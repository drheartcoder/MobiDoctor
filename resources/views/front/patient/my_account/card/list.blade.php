        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                        ...
                        @foreach( $card_details as $card )
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                <div class="payment-card default-card">
                                    <h4><b>{{ $card_type }}</b> <span>{{ $card_name }}</span></h4>
                                    <div class="payment-card-details">
                                        ...
                                        <div class="two-btns">
                                            <div class="half-btns">
                                                <button type="button" class="green-trans-btn btn_remove_card" data-id="{{ $id }}" data-customer_id="{{ $customer_id }}" data-card_id="{{ $card_id }}">Delete</button>
                                            </div>
                ...
                <div class="white-wrapper prescription-wrapper add-card-form">
                    ...
                    <form method="post" name="patient_add_card_form" id="patient_add_card_form" action="{{ url('/') }}/patient/my_account/card/add" autocomplete="off" >
                    {{ csrf_field() }}
...
<script type="text/javascript">
    ...
    function PatientAddCardValidationCheck()
    {
        ...
        else
        {
            ...
            $.ajax({
                url         : '{{ url("/") }}/patient/my_account/card/add',
                type        : 'post',
                data        : formData,
                processData : false,
                contentType : false,
    ...
    $(".btn_remove_card").click(function()
    {
        ...
        function(isConfirm)
        {
            ...
            {
                $.ajax({
                    url        : '{{ url("/") }}/patient/my_account/card/delete',
                    type       : 'post',
