                                ...
                                <table class="table">
                                    ...
                                    @foreach($arr_transactions['data'] as $key => $transactions)    
                                        <tr>
                                            ...
                                            <td> <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" href="{{$module_url_path}}/subscription/view_transaction?id={{isset($transactions['id'])?base64_encode($transactions['id']):0}}"  title="View"><i class="fa fa-eye" ></i></a>
                                            </td>
                                        </tr>
                                    @endforeach    
                                    </tbody>
