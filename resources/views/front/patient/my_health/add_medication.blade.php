        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="white-wrapper prescription-wrapper">
                    <h2>{{$page_title or ''}}</h2>
                    <form name="frm_add_medication" id="frm_add_medication" method="post" action="{{ $module_url_path }}/medication/store" enctype="multipart/form-data">
                        {{csrf_field()}}
    ...
    $("#btn_add_medication").click(function(){
        ...
        else
        {
            ...
            api.cards.get(card_id).then(function (cards)
            {
                ...
                $.ajax({
                    url         : "{{ $module_url_path }}/medication/store",
                    type        : 'post',
                    data        : formData,
                    processData : false,
                    contentType : false,
