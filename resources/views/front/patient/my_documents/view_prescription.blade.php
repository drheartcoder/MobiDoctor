                ...
                <div class="white-wrapper prescription-wrapper">
                    ...
                    <div class="prescription-section" id="list-wrapper">
                        ...
                        <div class="prescri-block">
                            <div class="prescri-name"><span class="doc-name">Consultation ID</span>: {{ $consult_id }}</div>
                            <div class="prescri-name"><span class="doc-name">Doctor Name</span>: {{ $doc_name }}</div>
                                    ...
                                    ?>
                                        <div class="prescri-name">
                                            <div class="presciption-view-icon">
                                                <a id="dec_name" data-name="name" data-file="{{ $name }}" data-path="{{ $name_file }}" href="" download>Download<i class="fa fa-download"></i></a>
                                            </div>
                                        </div>
                                    <?php
                                endif;
...
<script type="text/javascript">
    ...
    {   
        ...
        $("#dec_repeats").html( decrypt( "{{ $repeats or '' }}" ) );
        $("#dec_direction").html( decrypt( "{{ $direction or '' }}" ) );
