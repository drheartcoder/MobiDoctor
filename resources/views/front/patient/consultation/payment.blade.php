    ...
    <div class="container">
        <div class="booking-step-wrapper full-width">
            ...
            <div class="booking-title text-center">
                <div class="row">
                    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                        <a class="prev-arrow bg-img" href="{{ $module_url_path.'/'.$session_consultation_id }}/time">&nbsp;</a>
                    </div>
            ...
            <div class="booking-content payemnt-section">
                ...
                <form method="post" name="consultation_payment_form" id="consultation_payment_form" action="{{ url('/') }}/patient/consultation/{{ $session_consultation_id }}/payment/process" autocomplete="off" >
                    {{ csrf_field() }}

                    <input type="hidden" name="consultation_price" id="consultation_price" value="{{ $consultation_price }}" />
                    ...
                    <div class="payment-wrapper">
                        ...
                        <div class="user-info">
                            ...
                            <p>{{ date("H:i A, l, d F Y", strtotime($consultation_datetime)) }}</p>
                        </div>
                        
                        <div class="user-info">
                            <p><b>Patient</b></p>
                            <p>{{ $patient_firstname.' '.$patient_lastname }}</p>
                        </div>
                        ...
                        <div class="user-info description">
                            ...
                            <p>{{ $consultation_price }} <i class="fa fa-eur"></i></p>
                        </div>
                        
                        <div class="total-block">
                            <p>Total</p>
                            <h2>{{ $consultation_price }} <i class="fa fa-eur"></i></h2>
...
<script type="text/javascript">
    $(document).ready(function()
    {
        ...
        $("#apply_code").click(function() {
            ...
            var consultation_price = "{{ $consultation_price }}";
            ...
            if( $.trim( discount_code ) != '' )
            {
                ...
                $.ajax({
                    url        : '{{ url("/") }}/patient/consultation/{{ $session_consultation_id }}/payment/apply_discount',
                    type       : 'post',
    ...
    function payment()
    {
        ...
        $.ajax({
            url         : "{{ url('/') }}/patient/consultation/{{ Session::get('consultation_id') }}/payment/process",
            type        : 'post',
            data        : formData,
            processData : false,
            contentType : false,
            ...
            success     : function (res)
            {
                ...
                if(res.status == 'success')
                {
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "{{ url('/') }}/patient/consultation/{{ Session::get('consultation_id') }}/reason";
                    }, 6000);
                }
                else
                {
