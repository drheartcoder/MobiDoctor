        ...
        <div class="booking-completed-section">
            ...
            <div class="patient-details">
                <div class="doctor-section">
                    <div class="doctor-icon bg-img">&nbsp;</div>
                    <div class="doctor-details">
                        <p>{{ $patient_fname.' '.$patient_lname }}</p>
                        <span>Patient</span>
                    </div>
                </div>
            </div>
            ...
            <div class="info-tabbing-section">
                    ...
                    <div class="tabbing-details">
                        ...
                        <div class="instructions-list">
                            ...
                            <ul>
                                ...
                                <li>{{ $doctor_name }} will call you at <b>{{ $consultation_datetime }}.</b></li>
                ...
                <div class="info-tabbing-wrapper">
                    ...
                    <div class="tabbing-details">
                        <p>You have yet been charged - payment will only be processed once {{ $doctor_name }} confirms your booking.</p>
                ...
                <div class="two-btns">
                    ...
                    @if( $reschedule_option == 0 )
                        <div class="half-btns">
                            <a class="green-trans-btn reschedute-btn" href="{{ url('/') }}/patient/consultation/{{ $session_consultation_id }}/reschedule">
                    ...
                    <div class="half-btns">
                        <!-- <a class="green-btn completed-btn" href="{{ url('/') }}/patient/consultation/{{ $session_consultation_id }}/online_waiting_room"> -->
                        <a class="green-btn completed-btn" href="{{ url('/') }}/patient/my_consultation/upcoming/{{ $id }}/online_waiting_room">
