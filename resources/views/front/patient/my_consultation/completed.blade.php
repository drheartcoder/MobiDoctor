                                        ...
                                        <div class="consultation-tct-box">
                                            ...
                                            <div class="consu-drop-wrapper">
                                                ...
                                                <div class="consu-drop">
                                                    <ul>
                                                        <li><a href="{{ url('/') }}/patient/my_consultation/completed/{{ $id }}/online_waiting_room">Online Waiting Room</a></li>
                                                        <li><a href="{{ url('/') }}/patient/my_consultation/completed/{{ $id }}/details">View Consultation Details</a></li>
                                                        <li><a href="{{ url('/') }}/patient/my_consultation/completed/{{ $id }}/feedback_review">Feedback &amp; Review</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
