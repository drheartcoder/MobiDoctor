            ...
            <div class="mobidoctor-services-box">
                ...
                <div class="services-mobi-doctor-bx">
                    <div class="services-mobi-doctor-img">
                        <img src="{{url('/')}}/public/front/images/service-1.png" alt="service" />
                    </div>
                    <div class="services-mobi-title">Medical Advisory Services</div>
                </div>
                <div class="services-mobi-doctor-bx">
                    <div class="services-mobi-doctor-img">
                        <img src="{{url('/')}}/public/front/images/service-2.png" alt="service" />
                    </div>
                    <div class="services-mobi-title">Report Aquisition</div>
                </div>
                <div class="services-mobi-doctor-bx">
                    <div class="services-mobi-doctor-img">
                        <img src="{{url('/')}}/public/front/images/service-3.png" alt="service" />
                    </div>
                    <div class="services-mobi-title">Health Check</div>
                </div>
                <div class="services-mobi-doctor-bx">
                    <div class="services-mobi-doctor-img">
                        <img src="{{url('/')}}/public/front/images/service-4.png" alt="service" />
                    </div>
                    <div class="services-mobi-title">Bespoke Medical Products</div>
                </div>
                <div class="services-mobi-doctor-bx">
                    <div class="services-mobi-doctor-img">
                        <img src="{{url('/')}}/public/front/images/service-5.png" alt="service" />
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 col-md-5 col-lg-5">
                        <div class="sickness-right-img">
                            <img src="{{url('/')}}/public/front/images/inpact-img.png" alt="imge" />
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <div class="healthy-happy-left">
                            <img src="{{url('/')}}/public/front/images/happy-healty.png" alt="happy" />
                        </div>
        ...
        <div class="business-contact-section">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form name="frm_for_business" id="frm_for_business" method="post" action="{{url('/')}}/for_business/store">
                        {{csrf_field()}}
                        <div class="col-sm-12 col-md-7 col-lg-7">
                            <div class="contact-business-bx">
                                @include('front.layout._operation_status')
                                <div class="contact-business-title"> contact form </div>
                                <div class="contact-sms-img"><img src="{{url('/')}}/public/front/images/msg.png" alt="sms" /> </div>
