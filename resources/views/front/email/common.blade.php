                ...
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td style="padding:42px 0 8px 0; color: #858585; font-size:13px; letter-spacing: 1px;"><span style="font-size:11px;color#858585;margin-top:2px;vertical-align:top;">@</span>{{config('app.project.name')}}</td>
                                <td style="padding:42px 0 8px 0;">
                                    <div style="float:right; padding-right:15px;">
                                        <img src="{{url('/')}}/public/front/images/emailer-link.jpg" alt="link" style="vertical-align:middle;margin:-1px 2px 0 0;" /><a href="{{url('/')}}" style="text-decoration:none; color: #88ba7b; font-size:13px;"> Visit website </a> </div>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td bgcolor="#FFFFFF" style="padding:0px;box-shadow:0 0 12px #e8e8e8;-webkit-box-shadow:0 0 12px #e8e8e8;-moz-box-shadow:0 0 12px #e8e8e8;border-radius:4px 4px 0 0;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#88ba7b', endColorstr='#37a46e',GradientType=1 ); /* IE6-9 */
                                             height: 115px; text-align:center;border-radius:4px 4px 0 0;"><a href="#" style=" line-height:101px; text-decoration:none; letter-spacing: 3px; color:#fff; 
                                                font-size:30px; font-weight:200;">{{config('app.project.name')}}</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="text-align:center; padding:30px;color: #505050; line-height: 27px; font-size: 16px;">{!! $content !!}</td>
                            </tr>
                            ...
                            <tr>
                                <td style="text-align:center; color:#7a7a7a; font-size:14px; padding-bottom:20px;"> All the best, <br /> @ {{config('app.project.name')}}</td>
                            </tr>
