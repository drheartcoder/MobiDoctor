...
class NewsletterController extends Controller
{
	...
	public function delete($id=null)
	{
		if (isset($id) && $id!=null) 
		{
			$response = $this->MailchimpService->unsubscribe(base64_decode($id));
			if ($response=='SUCCESS') 
			{
				Flash::success("your removed successfully from subscription list.");
			}
		}
		else
		{
			Flash::error("Error while removing user from subscription list.");
		}
