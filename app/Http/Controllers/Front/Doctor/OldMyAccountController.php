...
class OldMyAccountController extends Controller
{
        ...
        if($request->hasFile('file_driving_licence'))
        {
            ...
            if(isset($driving_licence) && sizeof($driving_licence)>0)
            {
                ...
                else
                {
                    ...
                    $driving_licence_name   = sha1(uniqid().$driving_licence_name.uniqid()).'.'.$driving_licence_ext;
        ...
        if($request->hasFile('file_medical_registration'))
        {
            ...
            if(isset($medical_reg) && sizeof($medical_reg)>0)
            {
                ...
                else
                {
                    ...
                    $medical_reg_name   = sha1(uniqid().$medical_reg_name.uniqid()).'.'.$medical_reg_ext;
